...
GameMenu::GameMenu()
{
    ...
    _bg = initActor(new Box9Sprite,
                    arg_attachTo = _view,
                    arg_resAnim = resources::ui.getResAnim("box9"),
    ...
    TextStyle style;
    style.font = resources::ui.getResFont("big")->getFont();
    //vertical align
    ...
    const ResAnim* btns = resources::ui.getResAnim("buttons");
    //create 2 buttons
    ...
    for (int i = 0; i < 2; ++i)
    {
        ...
        //GameButton is user class inherited from Sprite
        spGameButton button = initActor(new GameButton,
                                      arg_resAnim = frame,
