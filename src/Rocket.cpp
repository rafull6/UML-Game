...
void Rocket::_init()
{
    ...
    sp->setResAnim(resources::ui.getResAnim("rocket"));
...
void Rocket::_update(const UpdateState& us)
{
	...
	pos += _dir * (us.dt / 10000.0f) * 500.0f;
...
void Rocket::explode()
{
    ...
    spTween tween = anim->addTween(Sprite::TweenAnim(resources::ui.getResAnim("explosion")), 200);
