...
MainMenuScene::MainMenuScene()
{
    ...
    sky->setResAnim(resources::ui.getResAnim("bg"));
    sky->attachTo(_view);
    ...
    */
    ...
    spSprite logo = initActor(new Sprite,
                              arg_resAnim = resources::ui.getResAnim("logo2"),
                              arg_attachTo = _view);
    ...
    */
    ...
    spSprite btn = initActor(new GameButton,
                             arg_name = "play",
                             arg_resAnim = resources::ui.getResAnim("play"),
    ...
    //create menu button
    btn = initActor(new GameButton,
                    arg_name = "exit",
                    arg_resAnim = resources::ui.getResAnim("menu"),
                    arg_anchor = Vector2(0.5f, 0.5f),
                    arg_attachTo = _view);
